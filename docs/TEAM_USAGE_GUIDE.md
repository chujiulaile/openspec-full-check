...
```powershell
npx --yes github:chujiulaile/openspec-full-check#v0.1.3 install --project . --tools codex
```

只使用 Claude Code：

```powershell
npx --yes github:chujiulaile/openspec-full-check#v0.1.3 install --project . --tools claude
```
