...
- Node.js 20 或更高版本；
- OpenSpec/OpenSpec-CN 1.8.0 或更高版本；
- 目标项目已经初始化 OpenSpec；
...
```powershell
npx --yes github:chujiulaile/openspec-full-check#v0.1.3 `
...
```powershell
npx --yes github:chujiulaile/openspec-full-check#v0.1.3 install --project . --tools codex,claude
```
...
```bash
npx --yes github:chujiulaile/openspec-full-check#v0.1.3 update --project .
npx --yes github:chujiulaile/openspec-full-check#v0.1.3 doctor --project .
npx --yes github:chujiulaile/openspec-full-check#v0.1.3 uninstall --project .
```
...
也可以下载 [v0.1.3 Release](https://github.com/chujiulaile/openspec-full-check/releases/tag/v0.1.3) 中的 `.tgz`：

```bash
npx ./openspec-full-check-0.1.3.tgz install --project . --tools codex,claude
```
